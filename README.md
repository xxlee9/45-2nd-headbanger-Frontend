...
Front_End : 김준섭, 김태원 , 이수빈 , 이소진 </br>
Back_End : 이지은, 장인석(Product_Manager), 탁호진(Project_Manager) </br>
...
- 페이지의 끝에 도달하면 자동으로 상품이 로드되어 추가적인 클릭이나 페이지 로딩 시간 없이 </br>
  원활하게 컨텐츠 탐색할 수 있어 사용자 경험 향상</br>
- 사용자의 참여도를 높이고 페이지 내에서의 잔류 시간 증가 </br>
...
- 사용자가 검색창에 입력하면 해당 검색어를 포함하는 캠프의 리스트를 필터링하고, </br>
  선택된 검색어는 URL의 검색 파라미터로 추가되어 상품 리스트 페이지가 적절하게 업데이트 되도록 구현</br>
