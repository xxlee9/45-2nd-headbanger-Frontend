...
- 캐러셀 (이미지 슬라이더) : 
  웹사이트에서 캐러셀 기능을 구현하여 여러 이미지가 자동으로 전환되도록 합니다.

- 카테고리별 캠프 노출 : 
  웹사이트에서 카테고리별로 캠프를 분류하여 해당 카테고리에 속하는 캠프들을 노출합니다.

- 테마별 캠프 노출 : 
  웹사이트에서 특정 테마에 맞는 캠프들을 분류하여 해당 테마에 속하는 캠프들을 노출합니다.
  
- 제주도 지역 (추천 매달 달라질 예정) 캠프 노출 : 
  웹사이트에서 매달 달라지는 추천 캠프 중에서 제주도 지역에 위치한 캠프들을 노출합니다.
